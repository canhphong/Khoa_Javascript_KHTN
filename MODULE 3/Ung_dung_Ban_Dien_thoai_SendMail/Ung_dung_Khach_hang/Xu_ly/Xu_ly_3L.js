...
function Tao_The_hien_Dien_thoai(Dien_thoai, Th_Cha) {
  ...
  <img class="card-img-top" src="https://phong-media.herokuapp.com/${Dien_thoai.Ma_so}.png" alt="">
  <div class="card-body">
      ...
      Loại nhóm: ${Dien_thoai.Nhom_Dien_thoai.Ten}
  </div>
...
function Xuat_Thong_tin_Cua_hang(Cua_hang, Th_Cha) {
    ...
    Th_Cha.appendChild(The_hien)
    var noi_dung_HTML = `<img src="https://phong-media.herokuapp.com/${Cua_hang.Ma_so}.png" class="img-fluid float-left" />
